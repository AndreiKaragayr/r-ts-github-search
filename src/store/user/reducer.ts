import {ActionsUserByNameType, IRepoDetail, IUserDetail} from "../../types/actions/types";
...
export const UserDetailReducer = ( state = defaultState, action: ActionsUserByNameType ): DefultStateType => {
  const { type } = action;
  switch( type ) {
